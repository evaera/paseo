...
function BrowserDataMenu({
  ...
  const leading = useMemo(() => <Download size={16} />, []);
  return (
    <DropdownMenu>
      <Tooltip delayDuration={0} enabledOnDesktop enabledOnMobile={false}>
        <TooltipTrigger asChild>
          <DropdownMenuTrigger accessibilityLabel="Browser data" style={triggerStyle}>
            <Download size={16} />
          </DropdownMenuTrigger>
        </TooltipTrigger>
        <TooltipContent side="bottom" align="center" offset={8}>
          <Text style={styles.toolbarTooltipText}>Browser data</Text>
        </TooltipContent>
      </Tooltip>
      <DropdownMenuContent align="end">
        <DropdownMenuItem leading={leading} onSelect={onImport}>
          Import browser data...
        </DropdownMenuItem>
      </DropdownMenuContent>
    </DropdownMenu>
    ...
    <View style={styles.container}>
      ...
      <View style={styles.chromeRow}>
        ...
        <View style={styles.chromeRight}>
          <BrowserDataMenu onImport={handleOpenBrowserImport} triggerStyle={baseIconButtonStyle} />
          <DeviceSizeMenu
